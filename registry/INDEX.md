...
**Total: 442 governed nodes** — searchable catalog: `docs/index.html`
...
- `entity.agennext` — AGenNext
- `entity.autonomyx` — AutonomyX
- `entity.economy` — Agent Economy
- `entity.openautonomyx` — OpenAutonomyX
- `entity.research-innovation` — Research & Innovation
